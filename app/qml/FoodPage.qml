...
ScrollView {
    ...
    component LabeledTextField: ColumnLayout {
        ...
        StyledTextField {
            ...
            hintText: labeledTextField.hintText
        }
    }
        ...
        AutoHeightRectangle {
            ...
            ColumnLayout {
                ...
                StyledTextArea {
                    ...
                    hintText: "可用性备注，例如档口活动、容易售罄、时段限制"
                ...
                AutoHeightRectangle {
                    ...
                    ColumnLayout {
                        ...
                        StyledTextArea {
                            ...
                            hintText: "例如：鸡腿饭 18 元，堂食，比较顶饱，油有点多，饭后不太犯困"
                            wrapMode: TextEdit.Wrap
                        }
